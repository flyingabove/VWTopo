 ...
 */
@Slf4j
public class VWTridentIntUpdater extends BaseStateUpdater<VWTridentIntState> {
    String tsFieldName;
    String msgName;

    public VWTridentIntUpdater(String msgName, String tsFieldName){
        this.tsFieldName = tsFieldName;
        this.msgName = msgName;
    }

    public void updateState(VWTridentIntState state, List<TridentTuple> tuples, TridentCollector collector) {
